    ...
    render() {
        ...
        return (
            ...
            <div className="resume-apper" onMouseOver={this.onHover} >
                <div  className="iconsize"><i class="fa fa-graduation-cap " aria-hidden="true" style={{color:'#fff'}}></i></div>
                <span className="mb-1" style={{fontWeight:600,fontFamily:this.props.font,marginLeft:10,fontSize:'25px'}}>EDUCATION</span>
                <hr />
