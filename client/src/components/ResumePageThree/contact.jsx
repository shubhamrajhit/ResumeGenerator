...
class contact extends Component {
    render() {
        ...
        return (
            <div className="list-contact3" style={{marginTop:-15,marginLeft:-22}}>
                        <ul >
                            <li className="first">
                                <div className="single-contact3" style={{display:this.props.email ?'block':'none'}}> 
                            ...
                            <li className="first">
                                <div className="single-contact3 ml-5" style={{display:this.props.phone ?'block':'none'}}>
                        ...
                        <ul style={{marginTop:-15}}>
                            <li className="second">
                                <div className="single-contact3" style={{display:this.props.web ?'block':'none'}}>
                            ...
                            <li className="second">
                                <div className="single-contact3 ml-4" style={{display:this.props.skype ?'block':'none'}}>
