            ...
            <div>
                <div className="resume mt-5">
                    ...
                    <div className="resume-details" >
                        <h4 className="degree"  contentEditable="true" placeholder="Awards" style={{color:'#BDC3C7',fontFamily:this.props.font}} ></h4>
                        <h6 className="school " contentEditable="true" placeholder="Position" style={{color:'#BDC3C7',fontFamily:this.props.font}}></h6>
