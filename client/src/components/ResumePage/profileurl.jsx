...
export default class profileurl extends Component {
    render() {
        return (
            <div className="ml-3">
             <h4 className="mb-3" style={{fontWeight:600}}>PROFILE DETAILS</h4>
                        ...
                        <ul>
                            <li>
                                ...
                                <i class="fa fa-github" aria-hidden="true" style={{marginRight:10,color:this.props.color}} ></i>
                                    <u><span
                                    className="contact-info" contentEditable="true" placeholder="Enter your birth date" style={{color:'#7F8C8D'}}>
                                    </span>
                                    </u>
                                </div>    
                            </li>
                            <li>
                                ...
                                <i class="fa fa-linkedin" aria-hidden="true" style={{marginRight:10,color:this.props.color}} ></i>
                                    <u><span
                                    className="contact-info" contentEditable="true" placeholder="Enter your Profile" style={{color:'#7F8C8D'}}>
                                    </span>
                                    </u>
                                </div>    
                            </li>
